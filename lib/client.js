...
try {
    ...
    console.log("Could not connect..please contact me❗\n94715264791 whatsapp support")
    process.exit(0)
}
...
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
    ...
    pastebin
        ...
        .fail(function(err) {
            console.log('Melisa couldn\'t find session with given SESSION_ID')
                //  console.log(err);
            process.exit(0)
        })
}
                        ...
                        if (anu.action == 'add') {
                            ...
                            if (events == "true") {
                                if (anu.id === secsupport) {
                                    ...
                                    const timenow = moment.tz('Asia/Colombo').format('DD/MM/YYYY')
...
*⭐Repo:* https://github.com/TimashaBuddilax/Queen-Melisa-Deploy
*⭐Public Group:* https://chat.whatsapp.com/CPAK2D9bbM554Fghwm7eQF
   `
                                    let buttonMessage = {
                                        image: await getBuffer(ppuser),
                                        caption: mbc,
                                        footer: `ǫᴜᴇᴇɴ ᴍᴇʟɪsᴀ ᴍᴅ ᴠᴇʀsɪᴏɴ`,
                                        mentions: [usersam],
                                        headerType: 4,
                                    }
  ...
  //=============================[Adding Buttons.]===================================================
	 await Void.sendMessage(anu.id, {
               text: ` `,
                ...
                templateButtons: [
                    { urlButton: { displayText: "ɢɪᴛʜᴜʙ", url: "https://github.com/TimashaBuddilax/Queen-Melisa-Deploy" } },
		{ urlButton: { displayText: "ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ", url: "94715264791" } },
		{ urlButton: { displayText: "ʙᴏᴛ ᴘᴜʙʟɪᴄ ɢʀᴏᴜᴘ", url: "https://chat.whatsapp.com/CPAK2D9bbM554Fghwm7eQF" } }
                ]
            })
	    */
...
*/
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `*ᴡᴇʟᴄᴏᴍᴇ ${pushname}*\n\n_ǫᴜᴇᴇɴ ᴍᴇʟɪsᴀ ɪs ᴡᴏʀᴋɪɴɢ ᴘʀᴇꜰᴇᴄᴛʟʏ_ 👸\n_ᴍᴇʟɪsᴀ ᴡᴏʀᴋɪɴɢ ᴀs ${Config.WORKTYPE}_\n_ᴊᴏɪɴ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ https://chat.whatsapp.com/Fk6USShr5teHYwONcyWv2T_\n\n💗 𝚃𝙷𝙰𝙽𝙺 𝙵𝙾𝚁 𝚄𝚂𝙸𝙽𝙶 𝚀𝚄𝙴𝙴𝙽 𝙼𝙴𝙻𝙸𝚂𝙰 💗` })
                    }
                }
                if (connection === 'close') {
